...
export class Convert {
    public static toSpaceXLaunches(json: string): SpaceXLaunches {
        return cast(JSON.parse(json), r("SpaceXLaunches"));
    }

    public static spaceXLaunchesToJson(value: SpaceXLaunches): string {
        return JSON.stringify(uncast(value, r("SpaceXLaunches")), null, 2);
    }
}
